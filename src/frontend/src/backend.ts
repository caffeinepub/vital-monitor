...
export class Backend implements backendInterface {
    ...
    async addHealthMetric(arg0: bigint, arg1: bigint, arg2: bigint, arg3: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addHealthMetric(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getAlarmEvents(arg0: bigint, arg1: bigint): Promise<Array<AlarmEvent>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAlarmEvents(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getHealthMetrics(arg0: bigint, arg1: bigint): Promise<Array<HealthMetric>> {
        if (this.processError) {
            try {
                const result = await this.actor.getHealthMetrics(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMovementAnomalies(arg0: bigint, arg1: bigint): Promise<Array<MovementAnomaly>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMovementAnomalies(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async reportMovementAnomaly(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.reportMovementAnomaly(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async triggerAlarm(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.triggerAlarm(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
